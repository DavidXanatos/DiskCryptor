...
int fill_segment_ref(const argon2_instance_t *instance,
    ...
    u64 pseudo_rand, ref_index, ref_lane;
    u32 prev_offset, curr_offset;
    u32 starting_index;
    u32 i;
    ...
    for (i = starting_index; i < instance->segment_length;
         ...
         */
        position.index = i;
        ref_index = index_alpha(instance, &position, (u32)(pseudo_rand & 0xFFFFFFFF),
                                ref_lane == position.lane);
...
#endif
	// on x64 sse2 is always available
